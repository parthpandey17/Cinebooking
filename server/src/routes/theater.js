...
const {
	getTheaters, getTheater, createTheater, updateTheater, deleteTheater,
	getTheaterByMovie, getUnreleasedTheater, getUnreleasedTheaterByMovie
...
router.route('/:id').get(getTheater).put(protect, authorize('admin'), updateTheater).delete(protect, authorize('admin'), deleteTheater)
